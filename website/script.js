// Function to fetch the star count
const repo = "Bookingjini-Labs/bookingjini-icons";
...
// Calling fetchStarCount function to fetch & display count
fetchStarCount();
    ...
    iconContainer.addEventListener("click", () => {
      ...
      setTimeout(() => {
        ...
        iconContainer.querySelector("img").src =
          "https://i.ibb.co/Jzrg63c/image-removebg-preview-1.png";
...
function searchIcon() {
  ...
  for (i = 0; i < li.length; i++) {
    ...
    if (
      jaroWinklerSimilarity(filter.toLowerCase(), txtValue.toLowerCase()) >=
        THRESHOLD ||
      filter == ""
    ) {
      li[i].style.display = "";
